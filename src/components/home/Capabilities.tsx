...
import { Sparkles, Sun, Scan, Aperture, Droplets, Waves, Box, Cloud, CloudSun, Mountain, Lightbulb, Moon, Palette, Sticker, Smile, Focus, Maximize, Gem, Layers, Globe, Sailboat, Anchor, Sunrise } from 'lucide-react';
