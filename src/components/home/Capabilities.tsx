...
import { Sparkles, Sun, Scan, Aperture, Droplets, Waves, FastForward, Box, Cloud, CloudSun, CloudOff, Mountain, Lightbulb, Moon, Palette, Sticker, Smile, Focus, Maximize, Gem, Layers, Globe, Sailboat, Anchor, Sunrise, Star, Flame, Contrast, Camera, GlassWater, Wind, Hourglass, Filter, SprayCan, Boxes, Eye, ScanLine, Umbrella, Map, Trees, Grid3x3, SlidersHorizontal, Atom, Brain, Move, Expand, Brush, Frame, Orbit, Film, Blend, BarChart3, ThermometerSun, Monitor, Zap, Haze, Sparkle, Waypoints, EyeOff, SquareDashed, Network, Layers3, Eclipse, BrickWall, Grid2x2, Cpu, Radar } from 'lucide-react';
