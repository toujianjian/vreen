...
import { Sparkles, Sun, Scan, Aperture, Droplets, Waves, Box, Cloud, Mountain, Lightbulb, Moon, Palette, Sticker, Smile, Focus, Maximize, Gem, Layers, Globe } from 'lucide-react';
