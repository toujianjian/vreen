...
import { Sparkles, Sun, Scan, Aperture, Droplets, Waves, FastForward, Box, Cloud, CloudSun, CloudOff, Mountain, Lightbulb, Moon, Palette, Sticker, Smile, Focus, Maximize, Gem, Layers, Globe, Sailboat, Anchor, Sunrise, Star, Flame, Contrast, Camera, GlassWater, Wind, Hourglass, Filter, SprayCan, Boxes, Eye, ScanLine, Umbrella, Map, Trees, Grid3x3, SlidersHorizontal, Atom, Brain, Move, Expand, Brush, Frame, Orbit, Film, Blend, BarChart3, ThermometerSun, Monitor, Zap, Haze, Sparkle, Waypoints, EyeOff, SquareDashed, Network, Layers3, Eclipse, BrickWall, Grid2x2, Cpu, Radar, Database, Cuboid, Radio, PaintBucket, Gauge, PersonStanding, PanelsTopLeft, Glasses, MousePointerClick, Move3d, Bone } from 'lucide-react';
...
const CAPS: Cap[] = [
  ...
  { key: 'visibilityBuffer', icon: Layers3, accent: 'text-neon-magenta' },
  { key: 'esm', icon: Eclipse, accent: 'text-neon-cyan' },
  { key: 'pom', icon: BrickWall, accent: 'text-neon-magenta' },
  { key: 'vsm', icon: Grid2x2, accent: 'text-neon-cyan' },
  { key: 'meshshader', icon: Cpu, accent: 'text-neon-magenta' },
  { key: 'meshDistanceField', icon: Radar, accent: 'text-neon-cyan' },
  { key: 'virtualTexturing', icon: Database, accent: 'text-neon-magenta' },
  { key: 'voxelConeTracing', icon: Cuboid, accent: 'text-neon-cyan' },
  { key: 'lightPropagationVolume', icon: Radio, accent: 'text-neon-amber' },
